...
public class NonleadCoachLogin {
    ...
    public void setUp() {
        ...
        nonleadcoch = Config.getProperty("nonleadcoch");
        coachPassword = Config.getProperty("coachpassword");
    }

    @Test
    public void testnonCoachLogin() {
//        loginPage.login("seak@mailinator.com", "User!234");
    	 loginPage.login(nonleadcoch, coachPassword);
     // Capture and add login details to Allure report
        String username = "kimi@yopmail.com";
