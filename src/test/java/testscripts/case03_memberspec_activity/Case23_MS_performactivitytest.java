...
import feature.case03_memberspec_activity.Case23_MS_performactivity;
import io.qameta.allure.*;

@Epic ("Cuesz Staff on member Summary page")
@Feature ("Verify on member summary page staff  able to view perform data by selecting dropdown values.")
...
public class Case23_MS_performactivitytest {
    ...
    @Description("Verify the perform dropdown features functionlaity .")
    @Story("Successfuly able to select values from perform dropdown features")
    ...
    public void advocateperformactivityTest() throws InterruptedException {
        ...
        Allure.link("Case23_MS_performactivitytest", dynamicLink);
        ...
        AllureUtils.captureScreenshot(driver, "Case23_MS_performactivitytest");
