...
import feature.case13_membercommunication.Case76_chattomemberredirection;
import io.qameta.allure.*;

@Epic ("Cuesz Staff testing for member coomunication ")
@Feature ("verify member communication redirection to member page")

public class Case76_chattomemberredirectiontest {
    private WebDriver driver;
    private AdvocateLogin advocateLogin;
    private Case76_chattomemberredirection memberlogicPage;
    ...
    public void setUp() {
        ...
        memberlogicPage = new Case76_chattomemberredirection(driver);
    ...
    public void advocatecmembercommunictaeTest() throws InterruptedException {
        ...
        Allure.link("Case76_chattomemberredirectiontest", dynamicLink);
        ...
        AllureUtils.captureScreenshot(driver, "Case76_chattomemberredirectiontest");
