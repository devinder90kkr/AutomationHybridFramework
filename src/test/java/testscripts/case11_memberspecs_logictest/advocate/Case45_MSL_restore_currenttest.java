...
import feature.case11_logicpage.Case45_MSL_restore_current;
...
public class Case45_MSL_restore_currenttest {
    private WebDriver driver;
    private AdvocateLogin advocateLogin;
    private Case45_MSL_restore_current memberlogicPage;
    ...
    public void setUp() {
        ...
        memberlogicPage = new Case45_MSL_restore_current(driver);
    ...
    @Description("Verify the functionality of the staff advocate's logic page in displaying assign Restore.")
