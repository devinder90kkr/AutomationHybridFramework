...
import feature.case11_logicpage.Case36_MSL_Staffnotes;
...
public class Case36_MSL_Staffnotestest {
    ...
    @Description("Verify the functionality of the staff advocate's logic page in displaying staff notes details.")
