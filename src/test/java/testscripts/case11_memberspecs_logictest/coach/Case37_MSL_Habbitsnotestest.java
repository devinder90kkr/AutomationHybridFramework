...
import feature.case11_logicpage.Case37_MSL_Habbitsnotes;
...
public class Case37_MSL_Habbitsnotestest {
    ...
    @Description("Verify the functionality of the staff COACH logic page in displaying habbits notes details.")
