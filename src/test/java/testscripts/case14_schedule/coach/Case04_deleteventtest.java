...
import feature.case14_schedule.Case04_deletevent;
...
public class Case04_deleteventtest {
    ...
    @Description("coach schdules and delete an event")
    ...
    public void advocateScheduleEventTest() throws InterruptedException {
        ...
        Allure.link("Case04_deleteventtest", dynamicLink);
        ...
        AllureUtils.captureScreenshot(driver, "Case04_deleteventtest");
