...
import feature.case14_schedule.Step12_07_SE_create_eventwithoutopic;
import io.qameta.allure.*;

@Epic ("Coach Scheduling")
@Feature ("Create without past date from master calendar")

public class Step12_07_SE_create_eventwithoutopictest {
    ...
    public void advocateScheduleEventTest() throws InterruptedException {
     ...
     // Generate a dynamic link based on some runtime conditions or data
        ...
        Allure.link("Step12_07_SE_create_eventwithoutopic", dynamicLink);
        ...
        AllureUtils.captureScreenshot(driver, "Step12_07_SE_create_eventwithoutopic");
