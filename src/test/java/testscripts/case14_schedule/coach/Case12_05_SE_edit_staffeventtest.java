...
import feature.case14_schedule.Step12_05_SE_edit_staffevent;
import io.qameta.allure.*;

@Epic ("Coach Scheduling")
@Feature ("Create without past date from master calendar")

public class Case12_05_SE_edit_staffeventtest {
    ...
    public void advocateScheduleEventTest() throws InterruptedException {
     ...
     // Generate a dynamic link based on some runtime conditions or data
        ...
        Allure.link("Case12_05_SE_edit_staffeventtest", dynamicLink);
        ...
        AllureUtils.captureScreenshot(driver, "Case12_05_SE_edit_staffeventtest");
