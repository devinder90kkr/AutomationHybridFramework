...
import feature.case14_schedule.Step12_10_SE_createeventbyselecteddatefromcalendar;
import io.qameta.allure.*;
@Epic ("Advocate Scheduling")
@Feature ("Create event from calendar")


public class Step12_10_SE_createeventbyselecteddatefromcalendartest {
    private WebDriver driver;
    private AdvocateLogin advocateLogin;
    private Step12_10_SE_createeventbyselecteddatefromcalendar scheduleEventPage;
    ...
    public void setUp() {
        ...
        scheduleEventPage = new Step12_10_SE_createeventbyselecteddatefromcalendar(driver);
    ...
    @Story("Schdule Events")
     ...
     public void advocateSchedulefromcalendarEventTest() throws InterruptedException {
        ...
        AllureUtils.captureScreenshot(driver, "Step12_09_SE_createeventforpasttest");
