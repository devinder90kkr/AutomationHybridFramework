...
import feature.case14_schedule.Step12_04_SE_view_staffevent;
import io.qameta.allure.*;

@Epic ("Advocate Scheduling")
@Feature ("View staff event from master calendar")
...
public class Case12_04_SE_view_staffevent {
    ...
    @Description("Advocate View staff event from master calendar")
    @Story("Schdule Events")
    
     public void advocateviewstaffEventTest() throws InterruptedException {
        ...
        Allure.link("Case12_04_SE_view_staffevent", dynamicLink);
        ...
        AllureUtils.captureScreenshot(driver, "Case12_04_SE_view_staffevent");
