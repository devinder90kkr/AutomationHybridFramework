...
import feature.case14_schedule.Step13_01createventfornextday;
import io.qameta.allure.*;
@Epic ("Advocate Scheduling")
@Feature ("Create event from calendar")


public class Step13_01createventfornextdaytest {
    private WebDriver driver;
    private AdvocateLogin advocateLogin;
    private Step13_01createventfornextday scheduleEventPage;
    ...
    public void setUp() {
        ...
        scheduleEventPage = new Step13_01createventfornextday(driver);
    ...
    @Story("Schdule Events")
     ...
     public void advocateSchedulefromcalendarEventTest() throws InterruptedException {
        ...
        AllureUtils.captureScreenshot(driver, "Step13_01createventfornextdaytest");
