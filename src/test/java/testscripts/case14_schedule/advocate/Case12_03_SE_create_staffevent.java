...
import feature.case14_schedule.Step12_03_SE_create_staffevent;
import io.qameta.allure.*;

@Epic ("Advocate Scheduling")
@Feature ("Create staff event from master calendar")
...
public class Case12_03_SE_create_staffevent {
    ...
    @Description("Advocate Create staff event from master calendar")
    @Story("Schdule Events")
     ...
     public void advocatecreatestaffEventTest() throws InterruptedException {
        ...
        Allure.link("Case12_03_SE_create_staffevent", dynamicLink);
        ...
        AllureUtils.captureScreenshot(driver, "Case12_03_SE_create_staffevent");
