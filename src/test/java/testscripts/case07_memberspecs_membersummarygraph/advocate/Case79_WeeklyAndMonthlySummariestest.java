...
import feature.case07_memberspecs_graphs.Case79_WeeklyAndMonthlySummaries;
...
public class Case79_WeeklyAndMonthlySummariestest {
    private WebDriver driver;
    private AdvocateLogin advocateLogin;
    private Case79_WeeklyAndMonthlySummaries  membersummarygraphPage;
    ...
    public void setUp() {
        ...
        membersummarygraphPage = new Case79_WeeklyAndMonthlySummaries (driver);
    ...
    public void advocateMemberhoverTest() throws InterruptedException {
        ...
        Allure.link("Case79_WeeklyAndMonthlySummariestest", dynamicLink);
        ...
        AllureUtils.captureScreenshot(driver, "Case79_WeeklyAndMonthlySummariestest");
 ...
 private String generateDynamicLink() {
        ...
        return "https://pre-staging.app.com/insights/training-load-analysis/627d168e40231fb0ba6a057a"; // Replace with your actual dynamic link
    }
