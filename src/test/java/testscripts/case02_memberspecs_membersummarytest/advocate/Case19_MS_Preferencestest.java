...
import feature.case02_memberspec_basic.Case19_MS_Preferences;
import io.qameta.allure.*;

@Epic ("Cuesz Staff on member Summary page")
@Feature ("Verify on member summary page staff able to set Preferences.")
...
public class Case19_MS_Preferencestest {
    ...
    @Description("Verify the Preferences functionlaity .")
    @Story("Successfuly able to add values in Preferences")
    ...
    public void advocatepreferenceTest() throws InterruptedException {
        ...
        Allure.link("Case19_MS_Preferencestest", dynamicLink);
        ...
        AllureUtils.captureScreenshot(driver, "Case19_MS_Preferencestest");
 ...
 private String generateDynamicLink() {
        ...
        return "https://app.com/member-specs/627d168e40231fb0ba6a057a"; // Replace with your actual dynamic link
    }
