...
import feature.case02_memberspec_basic.Case18_MS_DotAbiltyPM;
import io.qameta.allure.*;

@Epic ("Cuesz Staff on member Summary page")
@Feature ("Verify on member summary page staff able to access Ability to Perform.")
...
public class Case18_MS_DotAbiltest {
    ...
    @Story("Successfuly able to update values in Ability to Perform")
    ...
    public void advocatememberdotsTest() throws InterruptedException {
        ...
        Allure.link("Case18_MS_DotAbiltest", dynamicLink);
        ...
        AllureUtils.captureScreenshot(driver, "Case18_MS_DotAbiltest");
