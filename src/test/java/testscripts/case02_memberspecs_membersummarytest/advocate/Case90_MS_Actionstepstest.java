...
import feature.case02_memberspec_basic.Case90_MS_Actionsteps;
import io.qameta.allure.*;

@Epic ("Cuesz Staff on member Summary page for Action steps ")
@Feature ("Verify on member summary page staff able to check action steps feature")

public class Case90_MS_Actionstepstest {
    private WebDriver driver;
    private AdvocateLogin advocateLogin;
    private Case90_MS_Actionsteps membersummaryPage;
    ...
    public void setUp() {
        ...
        membersummaryPage = new Case90_MS_Actionsteps(driver);
    ...
    @Description("Verify the action steps features.")
    @Story("Successfuly click on add button and input values for action steps")
    ...
    public void actionsteps() throws InterruptedException {
     ...
     // Generate a dynamic link based on some runtime conditions or data
        ...
        AllureUtils.captureScreenshot(driver, "acionsteps");
