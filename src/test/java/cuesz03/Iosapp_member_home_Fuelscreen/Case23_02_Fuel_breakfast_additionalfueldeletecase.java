...
//	private By fish				= 		AppiumBy.iOSNsPredicateString("name == \"Fish\" AND label == \"Fish 218 kcal\"");
...
////        searchtext4.click();
//        additionalfuel.sendKeys(mobileTestData.food4);
//        
//        WebElement Keypaddone	= driver.findElement(mobileLocators.doneclick);
//        Keypaddone.click();
//        // Log console message to Allure
...
////        searchtext31.click();
//        additionalfuel2.sendKeys(mobileTestData.food5);
//        
...
//	
	...
	public void Homescreen() throws InterruptedException {
	    try {
	        ...
	        RetryUtils.retryingFindClick(driver, mobileLocators.Showclick, 3);
	        LOGGER.info("Click on brandedShowmore");
	        AllureUtils.logStep("Click on brandedShowmore");
	        AllureUtils.captureScreenshot(driver, "Case223_033");
	        ...
	        // Scroll to Goat Cheese
	        HashMap<String, Object> scrollObject1 = new HashMap<>();
	        scrollObject1.put("direction", "down");
	        scrollObject1.put("Goat Cheese", "Goat Cheese");
	        driver.executeScript("mobile:scroll", scrollObject1);

	        RetryUtils.retryingFindClick(driver, mobileLocators.Cheesegoat, 3);
	        LOGGER.info("Click on fuelselection1");
	        AllureUtils.logStep("Click on fuelselection1");
	        AllureUtils.captureScreenshot(driver, "Case223_034");

	        // Selection of category list
	        RetryUtils.retryingFindClick(driver, mobileLocators.categoryselection, 3);
	        RetryUtils.retryingFindClick(driver, mobileLocators.breakfastoption, 3);

	        Thread.sleep(2500);
	        RetryUtils.retryingFindClick(driver, mobileLocators.submitick, 3);
	        LOGGER.info("Click on submit");
	        AllureUtils.logStep("Click on submit");
	        AllureUtils.captureScreenshot(driver, "submit");
