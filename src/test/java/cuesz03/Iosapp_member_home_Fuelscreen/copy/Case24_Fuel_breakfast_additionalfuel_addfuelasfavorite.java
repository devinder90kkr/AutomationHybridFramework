...
//        searchtext41.click();
        ...
        additionalfuel.sendKeys(mobileTestData.food6);
        ...
        WebElement fuelselection1	= driver.findElement(mobileLocators.melonpan);
        ...
        WebElement meloclickplus		= driver.findElement(mobileLocators.melonpanplus);
...
//        searchtext81.click();
        ...
        fuelsearch2.sendKeys(mobileTestData.food7);
...
//        AllureUtils.captureScreenshot(driver, "Case24_13");
        ...
        WebElement Fuelselection3	= driver.findElement(mobileLocators.bicolexpress);
...
//        AllureUtils.captureScreenshot(driver, "Case24_15");
        Thread.sleep(2500);
        RetryUtils.retryingFindClick(driver, mobileLocators.submitick, 4);
     ...
     // Method to scroll to perform screen
        ...
        WebElement addfavorite 	= driver.findElement(mobileLocators.favoriteclick);
        addfavorite.click();
        ...
        WebElement favoritefield	= driver.findElement(mobileLocators.favoriteinput); 
        favoritefield.clear();
        ...
        WebElement submitaddfavorite 	= driver.findElement(mobileLocators.submitfavoriteclick);
        ...
        WebElement favoritefood	= driver.findElement(mobileLocators.favoritefoodclick);
        favoritefood.click();
        ...
        WebElement editadd = driver.findElement(mobileLocators.Fueladded);
        editadd.clear();
        ...
        WebElement submitaddfavorite2 	= driver.findElement(mobileLocators.submitfavoriteclick);
