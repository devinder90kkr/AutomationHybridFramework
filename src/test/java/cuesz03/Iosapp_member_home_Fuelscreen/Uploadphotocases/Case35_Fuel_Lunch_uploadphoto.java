...
public class Case35_Fuel_Lunch_uploadphoto extends AppiummobileBase {
	...
	public void Fuel_Lunch_uploadphoto() throws InterruptedException{
		...
		AllureUtils.captureScreenshot(driver, "Case35_Fuel_Lunch_uploadphoto1");
        ...
        Thread.sleep(2500);
        WebElement uploadicon	= driver.findElement(mobileLocators.uploadlunchimage);
        uploadicon.click();
        Thread.sleep(2500);
        // Log console message to Allure
        ...
        WebElement firstPhoto = driver.findElement(mobileLocators.imagselection3);
		firstPhoto.click();
		// Log console message to Allure
		...
		WebElement Submittap = driver.findElement(mobileLocators.lunctickoption);
		Submittap.click();
		// Log console message to Allure
