...
public class Case59mindfulwith_sosche_backbutton extends AppiummobileBase {
	private static final Logger LOGGER = LoggerFactory.getLogger(Case59mindfulwith_sosche_backbutton.class);
