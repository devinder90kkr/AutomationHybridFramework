...
import cuesz.logintest.DoctorLogin;
...
public class Case104_Workouttest_Templates_doctor {
    ...
    public void setUp() {
        ...
        doctorlogin = new DoctorLogin(); // Initialise the advocateLogin object
    ...
    public void workoutemplate() throws InterruptedException {
    	doctorlogin.setUp(); // Call the setUp method of AdvocateLogin to initialise loginPage
