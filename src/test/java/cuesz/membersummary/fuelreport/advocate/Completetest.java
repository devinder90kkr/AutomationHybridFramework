...
import cuesz.membersummary.fuelreport.Complete;
import cuesz.utils.AllureUtils;
import cuesz.utils.WebDriverManager;

import io.qameta.allure.*;

@Epic ("Cuesz Staff on Fuel Complete  page")
@Feature ("Verify staff able to access Complete for member")


public class Completetest {
    private WebDriver driver;
    private AdvocateLogin advocateLogin;
    private Complete  membersummarygraphPage;
    ...
    public void setUp() {
        ...
        membersummarygraphPage = new Complete (driver);
    ...
    @Description("Verify the functionality that staff able to access Complete.")
    @Story("Successfuly  access Complete for member in fuels")
