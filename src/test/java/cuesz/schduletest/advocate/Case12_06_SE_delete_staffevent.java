...
@Feature ("Delete staff event from master calendar")
...
public class Case12_06_SE_delete_staffevent {
    ...
    @Description("Advocate Delete staff event from master calendar")
    @Story("Schdule Events")
     ...
     public void advocatedeletestaffEventTest() throws InterruptedException {
        ...
        Allure.link("Case12_06_SE_delete_staffevent", dynamicLink);
        ...
        AllureUtils.captureScreenshot(driver, "Case12_06_SE_delete_staffevent");
