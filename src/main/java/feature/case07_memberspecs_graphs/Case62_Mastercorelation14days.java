...
public class Case62_Mastercorelation14days extends BasePage {
    ...
    public Case62_Mastercorelation14days(WebDriver driver) {
        super(driver);
    }
    ...
    public void mastercorelation() throws InterruptedException {
        ...
        WebElement option14Days = driver.findElement(By.xpath("//div[contains(@class, 'react-select-dropdown-prefix__option') and text()='14 Days']"));
        option14Days.click();
