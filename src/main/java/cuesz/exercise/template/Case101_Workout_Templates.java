...
public class Case101_Workout_Templates extends BasePage {
    ...
    public void Workouttemplate() throws InterruptedException {
        ...
        try {
        	...
        	WebElement templateicon = wait.until(ExpectedConditions.visibilityOfElementLocated(weblocators.templateicon));
            templateicon.click();
            // Log message to console and Allure report
	        LOGGER.info("Click on templateicon");
	        AllureUtils.logStep("Click on templateicon");
	        // Capture a screenshot and attach it to Allure
	        AllureUtils.captureScreenshot(driver, "Case101_Workout_Templates1");
        	
            WebElement templateplusicon = wait.until(ExpectedConditions.visibilityOfElementLocated(weblocators.templateplsicon));
            templateplusicon.click();
            // Log message to console and Allure report
