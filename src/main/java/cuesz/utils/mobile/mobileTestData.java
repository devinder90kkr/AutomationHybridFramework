...
//	builder1.moveToElement(datefield).click().sendKeys(TestData.EVENT_DATE).sendKeys(Keys.ENTER).perform();
	...
	public static final  String searchText = "lilt";
	...
	public static final String Proteins ="4.5";
	public static final String Carbohydrates = "37";
	public static final String Sugar = "22";
	public static final String Fat = "2.2";
	public static final String SaturatedFat = "1.3" ;
	public static final String DietaryFiber = "2.5";
	public static final String Cholesterol = "7.8";
	public static final String Sodium = "55";
	public static final String Iron = "0.4";
