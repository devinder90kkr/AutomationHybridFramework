...
//    public static final By addbttn = (By.xpath("//div[@class='add_btn']"));
    public static final By addbttn = (By.id("member-add-edit-action-step"));
	public static final By sendactionstep = (By.xpath("(//div[@id='member-add-edit-action-step'])[2]"));
    //public static final By actioninputfield =(By.xpath("//textarea[@placeholder='Add Note']"));
    public static final By actioninputfield = (By.xpath("//div[@class='jodit-wysiwyg']"));
    public static final By seeMoreButton = (By.xpath("//div[@class='logic_page_notes']//span[@class='see-more-less'][normalize-space()='See More']"));
...
//    public static final By editicon	= (By.xpath("(//button)[3]"));
    public static final By editicon	= (By.xpath("//button[@id='member-edit-action-step-0']"));    
//    public static final By edittextarea = (By.xpath("//textarea[@placeholder='Enter Here']"));    
	...
	public static final By edittextarea = (By.xpath("//div[@class='form-group d-flex flex-column']//div//div[@class='jodit-wysiwyg']"));
...
//    public static final By confirmbttn1 	=	(By.xpath("//button[@id='DecisionPopupRejection']"));
	...
	public static final By partnrtcusz =(By.xpath("//label[normalize-space()='Partner at automation']"));
